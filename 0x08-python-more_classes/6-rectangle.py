...
class Rectangle:
    ...
    Attributes:
        this is the number_of instances (int):instances of the rectangle
    """
    ...
    def __repr__(self):
        """this is to return the string rep of a rectangle"""
        size = "Rectangle(" + str(self.__width)
        size += ", " + str(self.__height) + ")"
        return (size)
